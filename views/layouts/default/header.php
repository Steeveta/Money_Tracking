...
<body>
 ...
 <nav class="z-depth-2" role="navigation">
   <div class="nav-wrapper container">
     <a id="logo-container" href="#" class="brand-logo">App</a>
     <ul class="right hide-on-med-and-down">
       ...
       <li><a class="dropdown-button" href="#!" data-activates="dropdown2">Cuentas<i class="material-icons right">arrow_drop_down</i></a></li>
       <li><a class="dropdown-button" href="#!" data-activates="dropdown3">Transacciones<i class="material-icons right">arrow_drop_down</i></a></li>
       <li><a class="dropdown-button" href="#!" data-activates="dropdown4">Categorias<i class="material-icons right">arrow_drop_down</i></a></li>
   <li class="col l2"><a href="<?php echo APP_URL; ?>users/logout">Cierra sesión<i class="material-icons right">vpn_key</i></a></li>
     </ul>
